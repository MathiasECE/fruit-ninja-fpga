...
fiftyfivenm_io_obuf \SRAM_DQ[0]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[1]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[2]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[3]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[4]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[5]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[6]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[7]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[8]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[9]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[10]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[11]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[12]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[13]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[14]~output (
...
fiftyfivenm_io_obuf \SRAM_DQ[15]~output (
...
fiftyfivenm_lcell_comb \is_read~0 (
	.dataa(read),
	.datab(gnd),
	.datac(gnd),
	.datad(reset),
...
fiftyfivenm_lcell_comb \SRAM_LB_N~0 (
	.dataa(byteenable_0),
	.datab(read),
	.datac(write),
	.datad(gnd),
...
fiftyfivenm_lcell_comb \SRAM_UB_N~0 (
	.dataa(byteenable_1),
	.datab(read),
	.datac(write),
	.datad(gnd),
...
fiftyfivenm_lcell_comb \SRAM_LB_N~1 (
	.dataa(read),
	.datab(write),
	.datac(gnd),
	.datad(gnd),
...
fiftyfivenm_lcell_comb \SRAM_OE_N~0 (
	.dataa(read),
	.datab(gnd),
	.datac(gnd),
	.datad(gnd),
...
fiftyfivenm_lcell_comb \SRAM_WE_N~0 (
	.dataa(write),
	.datab(gnd),
	.datac(gnd),
	.datad(gnd),
...
fiftyfivenm_lcell_comb \is_write~0 (
	.dataa(write),
	.datab(gnd),
	.datac(gnd),
	.datad(reset),
